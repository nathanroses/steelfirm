...
import LegalShieldImg from "@/public/images/planet.png"; 
import LegalOverlayImg from "@/public/images/planet-overlay.svg";
import PracticeAreaImg01 from "@/public/images/planet-tag-01.png"; 
import PracticeAreaImg02 from "@/public/images/planet-tag-02.png"; 
import PracticeAreaImg03 from "@/public/images/planet-tag-03.png"; 
import PracticeAreaImg04 from "@/public/images/planet-tag-04.png"; 
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              Comprehensive Strategies For Complex Cases
            </h2>
          </div>
          {/* Legal Shield Visualization */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Our defense strategies are meticulously crafted to analyze every angle of your case, identify key vulnerabilities in the prosecution's arguments, and build compelling counter-narratives.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Litigation Excellence</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                When your case goes to trial, our seasoned litigators leverage decades of courtroom experience to present compelling arguments, cross-examine witnesses effectively, and persuade judges and juries.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Our team conducts thorough investigations, examining every piece of evidence with a discerning eye to uncover facts that strengthen your case and challenge opposing arguments.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Legal Brief Excellence</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Our attorneys craft compelling legal briefs and motions that articulate persuasive arguments grounded in precedent, presenting your case in the most favorable light possible.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                We maintain transparent, consistent communication with our clients, ensuring you're informed at every stage of your case with clear explanations of complex legal concepts.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Our attorneys are skilled negotiators who can secure favorable settlements when appropriate, saving you the time, expense, and uncertainty of protracted litigation.
              </p>
            </article>
          </div>
        </div>
